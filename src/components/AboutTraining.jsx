const AboutPositons = ({ title, aboutTitle, positionContent, positionHighlight, requirements, skills }) => {
  return (
    <div className="w-full bg-[url(/src/assets/rocket-page/training/training-bg.png)] bg-neutral-white text-neutral-700 px-12 pb-[34px] pt-[50px] md:pt-16 md:pb-10 md:pr-20 md:pl-12 md:rounded-border-m border-neutral-200 border-2 relative">
      ...
      <div className="flex flex-col-reverse items-center gap-7 md:flex-row md:justify-between md:gap-12">
        ...
        <img
          src="src/assets/rocket-page/training/training-img-frontend-lg.svg"
          alt="Training image"
...
function AboutTraining() {
  const programs = [
    ...
    },
    {
      ...
      title: "UI 設計師",
      aboutTitle: "關於設計",
      positionContent: "關於主要以網頁 UI 設計 50%、網頁前端 50% 的雙技能樹養成，",
      ...
      <section className="flex flex-col items-center bg-neutral-100 relative">
        ...
        {/* <div className="mt-10 mb-[66px] pl-[49px] md:pl-0 md:mt-16 md:mb-32">
          ...
          <div className="flex gap-6 mb-7">
            <a href="#">
              <img
                src="src/assets/rocket-page/coach/coach-weijie.svg"
                alt="Weijie photo"
              />
            </a>
            <a href="#">
              <img
                src="src/assets/rocket-page/coach/coach-yinmin.svg"
                alt="Yinmin photo"
              />
            </a>
            <a href="#">
              <img
                src="src/assets/rocket-page/coach/coach-justin.svg"
                alt="Justin photo"
              />
            </a>
            <a href="#">
              <img
                src="src/assets/rocket-page/coach/coach-casper.svg"
                alt="Casper photo"
              />
            </a>
          </div>
        ...
        {/* <a
          href="#"
          className="max-w-[332px] md:max-w-[1076px] w-full bg-rocket-100 flex justify-center rounded-border-m border-2 border-neutral-700 absolute -bottom-11 py-5 md:py-6 group relative"
        >
          <h3 className="font-bold text-mobile-h3 md:text-desktop-h3 text-neutral-700">
            馬上報名！
          </h3>
          <img
            src="src/assets/rocket-page/ic-go-rocket.svg"
            alt="Go button logo"
